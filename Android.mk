...
$(VENDOR_SYMLINKS): $(LOCAL_INSTALLED_MODULE)
	...
	@ln -sf /vendor/lib/egl/libGLES_mali.so $(TARGET_OUT_VENDOR)/lib/hw/vulkan.mt6763.so
	@ln -sf /vendor/lib64/egl/libGLES_mali.so $(TARGET_OUT_VENDOR)/lib64/hw/vulkan.mt6763.so
	$(hide) touch $@
